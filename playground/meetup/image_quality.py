...
def process_images(images: typing.List[Path], grid_size=(10, 10), max_workers=None, output_dir:Path=None):
    """
    ...
    for image_id, result in results:
        ...
        for metric_name in metrics.keys():
            ...
            metric_result = result[metric_name].reshape(100)
...
def analyze_image_quality(folder_path, grid_size=(10, 10), max_images=None, output_dir=None):
    """
    ...
    # 2. Process images
    aggregated_results = process_images(images, grid_size, max_workers=6, output_dir=output_dir)
