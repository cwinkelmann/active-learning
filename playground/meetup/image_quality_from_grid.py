...
def process_grid(grid_file_path: Path, grid_size=(10, 10), max_workers=None, output_dir:Path=None):
    """
    ...
    for _, row in metric_dumps.iterrows():
        ...
        for metric_name in metrics.keys():
            ...
            metric_result = row[metric_name].reshape(10, 10)
...
def visualise_image_quality(grid_path, grid_size=(10, 10), max_images=None, output_dir=None):
    """
    ...
    aggregated_results = process_grid(grid_path, grid_size, max_workers=6, output_dir=output_dir)
