"""
increase the resolution of an images
"""
...
class SuperResolution():
    def __init__(self, scale_factor, model_type = None):
    ...
    def super_resolution(self, input_path, output_path):

        return super_resolve(input_path=input_path, output_path=output_path,
                             sr_model=self.sr_model, scale_factor=self.scale_factor,
                             sharpen=0.1, denoise=True, enhance_contrast=False)


def enhance_aerial_image(img, sr_model, sharpen_factor=0.1, denoise=True, enhance_contrast=True):
    """
...
if __name__ == "__main__":
    ...
    sr = SuperResolution(scale_factor=2, model_type='edsr')
