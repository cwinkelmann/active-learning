...
from active_learning.scripts.hasty_to_tile.data_configs import train_segments_1, val_segments_1, test_segments_1
...
if __name__ == "__main__":
    ...
    datasets = [train_segments_1, val_segments_1, test_segments_1 ]
    report = {}
