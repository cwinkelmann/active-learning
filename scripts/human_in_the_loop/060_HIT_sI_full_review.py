...
#
# from scripts.human_in_the_loop.helper import hit_fp_cvat_upload, hit_full_cvat_upload
#
...
#     )
#
#     hit_full_cvat_upload(config=delplanqetrain, report_path=delplanqetrain__report_path)
