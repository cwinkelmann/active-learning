...
#
#     ## TODO add a train/val/test split here
#
#     tile_size = resolution // scale_factor
#     # /Volumes/G-DRIVE/DD_MS_COG_Prepared_Training_2025_06_02
#     output_object_dir = Path(f"/Volumes/2TB/DD_MS_COG_Prepared_Training_2025_06_02/herdnet_{tile_size}/iguana")
#     output_empty_dir = Path(f"/Volumes/2TB/DD_MS_COG_Prepared_Training_2025_06_02/herdnet_{tile_size}/empty")
#
#     analysis_output_dir = Path("/Volumes/2TB/DD_MS_COG_Prepared_Training_2025_06_02/herdnet_analysis/")
#     vis_output_dir = Path("/Volumes/2TB/DD_MS_COG_Prepared_Training_2025_06_02/visualisation")
#     tile_output_dir = Path("/Volumes/2TB/DD_MS_COG_Prepared_Training_2025_06_02/tiff_tiles")
#
#
...
#         print(f"Processing idx {index} out of {len(df_mapping)}")
#         try:
...
#
#             # if not orthomosaic_path.name == "Scruz_SCM01_06012023.tif":
#             #     continue
#
...
#                                                                             format=format, OBJECT_CENTERED=True
#                                                                             )
#
...
#             problematic_data_pairs.append(row)
#         except OSError:
#             row["reason"] = "TIFFFillTile"
#             logger.error(f"TIFFFillTile: {row}")
#             problematic_data_pairs.append(row)
...
#             problematic_data_pairs.append(row)
#         except Exception:
#             row["reason"] = "UnknownError"
#             logger.error(f"UnknownError: {row}")
#             problematic_data_pairs.append(row)
#
#
#
