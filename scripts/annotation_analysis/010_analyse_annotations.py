...
if __name__ == "__main__":
    ...
    datasets = {
        "Floreana": ['Floreana_22.01.21_FPC07', 'Floreana_03.02.21_FMO06', 'FLMO02_28012023', 'FLBB01_28012023',
                           'Floreana_02.02.21_FMO01', 'FMO02', 'FMO05', 'FMO03', 'FMO04', 'FPA03 condor', 'FSCA02', 'floreana'],
        "Floreana_best": ['Floreana_03.02.21_FMO06',
                     'Floreana_02.02.21_FMO01', 'FMO02', 'FMO05', 'FMO04', 'FMO03', 'FPA03 condor'],
        "Fernandina_s": ['Fer_FCD01-02-03_20122021_single_images', 'FPM01_24012023', 'Fer_FPE02_07052024'],
        "Genovesa": ['Genovesa'],
    ...
    for dataset in datasets:  # , "val", "test"]:
        ...
        vis_path = output_path_dset / f"visualisations_{overlap}_{crop_size}"
        ...
        fig = plot_frequency_distribution(df_parameter, columns=['width', 'height', 'area'])
        fig.savefig(vis_path / f"frequency_distribution_{island}.png")
        fix2 = plot_visibility_scatter(df_parameter)
        fix2.savefig(vis_path / f"visibility_scatter_{island}.png")
        plt.show()
        ...
        plt.show()
        logger.info(f"Saved visualisations to {vis_path}")
        """
