...
def process_slice(dataset, x_offset, y_offset, x_size, y_size, output_path, threshold=90, driver: osgeo.gdal.Driver = None,
...
class GeoSlicer():
    ...
    """
    def __init__(self, base_path: Path, image_name: str, grid: gpd.GeoDataFrame):
    ...
    def slice_annotations(self, x_size, y_size, points_gdf: gpd.GeoDataFrame):
        # Load GeoJSON points
        ...
        points_gdf.to_csv("points_with_pixels.csv", index=False)
    ...
    def slice_very_big_raster(self):
        ...
        cut_geospatial_raster_with_grid_gdal(raster_path=self.base_path.joinpath(self.image_name)



    def create_vector_grid(self, x_size, y_size, overlap_ratio):
        """
        Create a vector grid for a geospatial raster.
        :param x_size: in meters
        :param y_size: in meters
        :param overlap_ratio: 0..1
        :return:
        """
